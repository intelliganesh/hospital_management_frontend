...
const ConsultationForm: React.FC<FormTypeProps> = ({ formType = "add" }) => {
  ...
  const medicineLifestyleRef = useRef(null);
  const documentsRef = useRef(null);
  ...
  // const handleSectionClick = (sectionRef: any, refName: string) => {
  //   // If clicking the same section, just scroll
  //   if (expandedSection === refName) {
  ...
  const handleSectionClick = (sectionRef: any, refName: string) => {
    ...
    // Wait for collapse animation to mostly complete
    setTimeout(() => {
      setExpandedSection(refName);
      setTimeout(() => {
        scrollToSection(sectionRef);
  ...
  // const finalPatientId = consultationDetailData?.consultations?.relinkPatient
  //   ? formValues?.patient_id // must select
  //   : formValues?.patient_id || consultationData?.consultations?.patient_id; // fallback
  // console.log("finalPatientId", finalPatientId);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const finalPatientId = consultationDetailData?.consultations
        ?.relinkPatient
        ? formValues?.patient_id // must select
        : formValues?.patient_id || consultationData?.consultations?.patient_id; // fallback
      console.log("finalPatientId", finalPatientId);
      ...
      for (let [key, value] of formData.entries()) {
        ...
        // }
        // console.log("iop", key === "internal_opening_position" && value);
        ...
        if (formData.get("post_surgery_details") === "on") {
          (consultationFormObj as any)["post_surgery_details"] = "yes";
        } else {
          (consultationFormObj as any)["post_surgery_details"] = "no";
        }
        if (
          key === "dre_induration_at" ||
          key === "proctoscopy_secondary_position" ||
          key === "proctoscopy_anal_polyp_at" ||
          key === "previous_scar_position" ||
          key === "abscess_position"
        ) {
      ...
      if (formValues) {
        ...
        consultationFormObj = {
          ...
          test_in_same_hospital: !!consultationFormObj?.test_in_same_hospital,
          doctor_id: consultationData?.consultations?.doctor_id,
          patient_id: finalPatientId || "", // ✅ CORRECT
          appointment_id: consultationData?.consultations?.appointment_id,
        };
      }
      // console.log(consultationFormObj, "result");
      ...
      delete consultationFormObj["additional_cost"];

      if (
        consultationDetailData?.consultations?.relinkPatient &&
        !finalPatientId
      ) {
  ...
  return (
    <View className="min-h-screen dark:bg-background flex flex-col  items-center p-4">
      ...
      <ConsultationModels
        consultationType={consultationData?.consultations?.type}
      >
        <View className="bg-background rounded-lg  w-full max-w-8xl p-6 md:p-8 mb-8">
          ...
          {medicinePopup ? (
            ...
            <React.Fragment>
              <form onSubmit={handleSubmit}>
                <View className="mb-8 border border-border rounded-lg p-2 sticky top-0 bg-background z-40 shadow-lg flex gap-2 overflow-x-auto">
                  <Button
                    className={`flex-1 ${
                      activeSection === "patientDetails"
                        ? `${TAB_COLORS.patientDetails.primary} ${TAB_COLORS.patientDetails.primaryHover} ${TAB_COLORS.patientDetails.darkPrimary} ${TAB_COLORS.patientDetails.shadow} ${TAB_COLORS.patientDetails.textColor} font-semibold`
                        : `${TAB_COLORS.patientDetails.textColor} font-semibold`
                    }`}
                    variant={
                      activeSection === "patientDetails" ? undefined : "ghost"
                    }
                    size="small"
                    onClick={() => {
                      handleSectionClick(patientDetailsRef, "patientDetails");
                    }}
                  >
                    {/* Appointment & Medical */}
                    Clinical History
                  ...
                  {/* <Button
                    variant={`${activeSection === "medicalHistory" ? "primary" : "ghost"
                      }`}
                    size="small"
                  ...
                  <Button
                    className={`flex-1 ${
                      activeSection === "examination"
                        ? `${TAB_COLORS.examination.primary} ${TAB_COLORS.examination.primaryHover} ${TAB_COLORS.examination.darkPrimary} ${TAB_COLORS.examination.shadow} ${TAB_COLORS.examination.textColor} font-semibold`
                        : `${TAB_COLORS.examination.textColor} font-semibold`
                    }`}
                    variant={
                      activeSection === "examination" ? undefined : "ghost"
                    }
                    size="small"
                    onClick={() => {
                      handleSectionClick(examinationRef, "examination");
                    }}
                  >
                  ...
                  {consultationDetailData &&
                    consultationDetailData?.consultations?.type ===
                      ...
                      <Button
                        className={`flex-1 ${
                          activeSection === "fistula"
                            ? `${TAB_COLORS.fistula.primary} ${TAB_COLORS.fistula.primaryHover} ${TAB_COLORS.fistula.darkPrimary} ${TAB_COLORS.fistula.shadow} ${TAB_COLORS.fistula.textColor} font-semibold`
                            : `${TAB_COLORS.fistula.textColor} font-semibold`
                        }`}
                        variant={
                          activeSection === "fistula" ? undefined : "ghost"
                        }
                        size="small"
                        onClick={() => {
                          handleSectionClick(fistulaRef, "fistula");
                        }}
                      >
                        Fistula
                      </Button>
                  ...
                  {/* <Button
                    className={`flex-1 ${
                      activeSection === "management"
                        ? `${TAB_COLORS.management.primary} ${TAB_COLORS.management.primaryHover} ${TAB_COLORS.management.darkPrimary} ${TAB_COLORS.management.shadow} ${TAB_COLORS.management.textColor} font-semibold`
                        : `${TAB_COLORS.management.textColor} font-semibold`
                    }`}
                    variant={
                      activeSection === "management" ? undefined : "ghost"
                    }
                    size="small"
                    onClick={() => {
                      handleSectionClick(managementsRef, "management");
                    }}
                  >
                    Management
                  </Button> */}
                  {/* <Button
                    variant={`${activeSection === "managements" ? "primary" : "ghost"
                      }`}
                    size="small"
                  ...
                  <Button
                    className={`flex-1 ${
                      activeSection === "treatmentPlan"
                        ? `${TAB_COLORS.treatmentPlan.primary} ${TAB_COLORS.treatmentPlan.primaryHover} ${TAB_COLORS.treatmentPlan.darkPrimary} ${TAB_COLORS.treatmentPlan.shadow} ${TAB_COLORS.treatmentPlan.textColor} font-semibold`
                        : `${TAB_COLORS.treatmentPlan.textColor} font-semibold`
                    }`}
                    variant={
                      activeSection === "treatmentPlan" ? undefined : "ghost"
                    }
                    size="small"
                    onClick={() =>
                      handleSectionClick(treatmentPlanRef, "treatmentPlan")
                    }
                  >
                    Treatment Plan
                  </Button>
                  ...
                  <Button
                    className={`flex-1 ${
                      activeSection === "medicineLifestyle"
                        ? `${TAB_COLORS.medicineLifestyle.primary} ${TAB_COLORS.medicineLifestyle.primaryHover} ${TAB_COLORS.medicineLifestyle.darkPrimary} ${TAB_COLORS.medicineLifestyle.shadow} ${TAB_COLORS.medicineLifestyle.textColor} font-semibold`
                        : `${TAB_COLORS.medicineLifestyle.textColor} font-semibold`
                    }`}
                    variant={
                      activeSection === "medicineLifestyle"
                        ? undefined
                    ...
                    onClick={() =>
                      handleSectionClick(
                        medicineLifestyleRef,
                        "medicineLifestyle",
                      )
                    }
                  >
                    Test, Medicines & lifestyle
                  </Button>
                  <Button
                    className={`flex-1 ${
                      activeSection === "documents"
                        ? `${TAB_COLORS.documents.primary} ${TAB_COLORS.documents.primaryHover} ${TAB_COLORS.documents.darkPrimary} ${TAB_COLORS.documents.shadow} ${TAB_COLORS.documents.textColor} font-semibold`
                        : `${TAB_COLORS.documents.textColor} font-semibold`
                    }`}
                    variant={
                      activeSection === "documents" ? undefined : "ghost"
                    }
                    size="small"
                    onClick={() =>
                      handleSectionClick(documentsRef, "documents")
                    }
                  >
                    Documents
                  </Button>
                  <Button
                    className={`flex-1 ${
                      activeSection === "consultationBilling"
                        ? `${TAB_COLORS.consultationBilling.primary} ${TAB_COLORS.consultationBilling.primaryHover} ${TAB_COLORS.consultationBilling.darkPrimary} ${TAB_COLORS.consultationBilling.shadow} ${TAB_COLORS.consultationBilling.textColor} font-semibold`
                        : `${TAB_COLORS.consultationBilling.textColor} font-semibold`
                    }`}
                    variant={
                      activeSection === "consultationBilling"
                        ? undefined
              ...
              /> */}
                  ...
                  >
                    ...
                    <NewSectionTwo
                      mainOnSetHandler={onSetHandler}
                      autoOpen={expandedSection === "patientDetails"}
                      colorScheme={TAB_COLORS.patientDetails}
                    />
                  </View>
                </View>
                {/* <View
              ...
              /> */}
                  <NewSectionThree
                    ...
                    errorsTest={errors.test_id}
                    mainOnSetHandler={onSetHandler}
                    autoOpen={expandedSection === "examination"}
                    colorScheme={TAB_COLORS.examination}
                  />
                </View>
                {consultationDetailData &&
                  consultationDetailData?.consultations?.type ===
                    ...
                    >
                      <CollapsibleContainer
                        title="Fistula"
                        variant="custom"
                        colorScheme={TAB_COLORS.fistula}
                        autoOpen={expandedSection === "fistula"}
                        headerTitleClassName="!text-2xl"
                      >
                        <NewSectionSeven
                          initialData={sectionSevenDetailData}
                ...
                >
                  <CollapsibleContainer
                    title="Management"
                    variant="custom"
                    colorScheme={TAB_COLORS.management}
                    autoOpen={expandedSection === "management"}
                    headerTitleClassName="!text-2xl"
                  >
                    <NewSectionEight />
                  </CollapsibleContainer>
                ...
                >
                  <CollapsibleContainer
                    ...
                    variant="custom"
                    colorScheme={TAB_COLORS.treatmentPlan}
                    autoOpen={expandedSection === "treatmentPlan"}
                    headerTitleClassName="!text-2xl"
                  >
                    <TreatmentPlan />
                  </CollapsibleContainer>
                ...
                <View
                  className="space-y-4 mt-16"
                  id="medicineLifestyle"
                  ref={medicineLifestyleRef}
                  style={{ scrollMarginTop: "50px" }}
                >
                  <NewSectionFour
                    mainOnSetHandler={onSetHandler}
                    autoOpen={expandedSection === "medicineLifestyle"}
                    colorScheme={TAB_COLORS.medicineLifestyle}
                  />
                </View>
              ...
              <Input name="type" hidden value={formData.examination_type} />
                ...
                >
                  <CollapsibleContainer
                    title="Documents"
                    variant="custom"
                    colorScheme={TAB_COLORS.documents}
                    autoOpen={expandedSection === "documents"}
                    headerTitleClassName="!text-2xl"
                  >
                ...
                >
                  <CollapsibleContainer
                    ...
                    variant="custom"
                    colorScheme={TAB_COLORS.consultationBilling}
                    defaultOpen={true}
                    headerTitleClassName="!text-2xl"
                  >
                    {/* <Text
                  ...
                  >
                    ...
                    <View className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center mb-6">
                      <View className="mt-2">
                        <Input
                          type="date"
                          id="next_visit_date"
