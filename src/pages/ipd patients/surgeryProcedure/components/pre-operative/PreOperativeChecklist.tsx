...
const initialChecklistFormValues: PreOperativeChecklistData = {
  ipd_id: "",
  ipd_surgery_id: "",
  q01_investigations: "",
  q02_chest_xray_ecg: "",
...
export const PreOpChecklist: React.FC = () => {
  ...
  const { values, onSetHandler } = useForm<PreOperativeChecklistData>(
    checklistDetailData ?? initialChecklistFormValues,
  );
