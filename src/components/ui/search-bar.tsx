...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  const variantClasses = {
    default: "bg-background  border-border rounded-lg focus:outline-none",
    filled:
  ...
  return (
    <MySearchComponent parentType={parentType} handleSubmit={handleSubmit}>
      <View
